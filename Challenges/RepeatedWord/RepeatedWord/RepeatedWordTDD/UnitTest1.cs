...
namespace RepeatedWordTDD
{
    public class UnitTest1
    {
        ...
        public void RepeatedWordTestOne()
        {
            ...
            Assert.Equal("a", RepeatedWord.Program.firstRepeatedWord(testOne));
        }
        [Fact]
        public void RepeatedWordTestTwo()
        {
            ...
            Assert.Equal("it", RepeatedWord.Program.firstRepeatedWord(testTwo));
        }
        [Fact]
        public void RepeatedWordwithCommas()
        {
            ...
            Assert.Equal("summer", RepeatedWord.Program.firstRepeatedWord(testThree));
        }
        ...
        public void EmptyStringTest()
        {
            ...
            Assert.Equal("No repeated word found.", RepeatedWord.Program.firstRepeatedWord(testOne));
        }
        ...
        public void NoRepeatedFoundTest(string input)
        {
            ...
            Assert.Equal("No repeated word found.", RepeatedWord.Program.firstRepeatedWord(input));
        }
    }
}
